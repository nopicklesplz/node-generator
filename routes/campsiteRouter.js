...
campsiteRouter
    ...
    .put(authenticate.verifyUser, (req, res, next) => {
        Campsite.findById(req.params.campsiteId)
            .then((campsite) => {
                const reqCommentExistsInCampsite = campsite && campsite.comments.id(req.params.commentId)
                if (reqCommentExistsInCampsite) {
                    // if the author of the comment is the user making the request then
                    const reqUserIsCommentAuthor = campsite.comments.id(req.params.commentId).author._id.equals(req.user._id)
